...
/*
//Makes image not expand strangely, BUT crops out image overflow
        mInsurance.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                int viewWidth = mInsurance.getMeasuredWidth();
                int viewHeight = mInsurance.getMeasuredHeight();
                Drawable src = mInsurance.getDrawable();
                if (src != null) {
                    ...
                    mInsurance.setScaleType(ImageView.ScaleType.MATRIX);
                    mInsurance.setImageMatrix(matrix);
                }
            }
        });
*/
